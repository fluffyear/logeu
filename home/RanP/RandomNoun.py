...
d3_elpis = {1: "ις", 2: "ιδα", 3: "ιδος", 4: "ιδι", 5: "ιδες", 6: "ιδας", 7: "ιδων", 8: "ισι(ν)"}
...
d3_bous = {1: "υς", 2: "υν", 3: "ος", 4: "ι", 5: "ες", 6: "υς", 7: "ων", 8: "υσι(ν)"}
...
d3_odous = {1: "υς", 2: "ντα", 3: "ντος", 4: "ντι", 5: "ντες", 6: "ντας", 7: "ντων", 8: "υσι(ν)"}
...
def rand_all():
    ...
    if n_type in [n3_swma, n1_fwvn, n1_tolma, n1_xwra, n3_dakru, n3_vuks]:
        return corr[part], base[:-1] + di.get(part), di, part, base[:-1]
    elif n_type in [n2_vous, n2_ostouv, n3_vaus]:
        return corr[part], base[:-3] + di.get(part), di, part, base[:-3]
    else:
        return corr[part], base[:-2] + di.get(part), di, part, base[:-2]
