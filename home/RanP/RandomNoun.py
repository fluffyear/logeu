...
d3_xeir = {1: "ειρ", 2: "ειρα", 3: "ειρος", 4: "ειρι", 5: "ειρες", 6: "ειρας", 7: "ειρων", 8: "ερσι(ν)"}
...
d3_vuks = {1: "υξ", 2: "υκτα", 3: "υκτος", 4: "υκτι", 5: "υκτες", 6: "υκτας", 7: "υκτων", 8: "υξι(ν)"}
d3_sus = {1: "υς", 2: "υν", 3: "υος", 4: "υι", 5: "υες", 6: "υς", 7: "υων", 8: "υσι(ν)"}
d3_dakru = {1: "ρυ", 2: "ρυ", 3: "ρυος", 4: "ρυι", 5: "ρυα", 6: "ρυα", 7: "ρυων", 8: "ρυσι(ν)"}
d3_leimwv = {1: "ων", 2: "ωνα", 3: "ωνος", 4: "ωνι", 5: "ωνες", 6: "ωνας", 7: "ωνων", 8: "ωσι(ν)"}
d3_uios = {1: "ος", 2: "ον", 3: "ου", 4: "ῳ", 5: "οι", 6: "ους", 7: "ων", 8: "οις"}
dct1 = {
    n1_fwvn: d1_fwvn,
    n1_tolma: d1_tolma,
    n1_xwra: d1_xwra,
...
def rand_all():
    ...
    elif n_type in [n2_vous, n2_ostouv, n3_vaus, n3_xeir]:
